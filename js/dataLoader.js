...
function getCurrentPage() {
  ...
  if (path.includes("mad-car-arena-privacy.html")) return "privacy";
  if (path.includes("mad-car-arena-cookies.html")) return "cookies";
  if (path.includes("mad-car-arena-disclaimer.html")) return "disclaimer";
  return "home";
}
