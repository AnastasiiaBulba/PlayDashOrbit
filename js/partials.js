...
async function loadHeader() {
  try {
    const response = await fetch("./mad-car-arena-partials/header.html");
    if (!response.ok) {
                ...
                <div id="cookie-bar" class="cookie-bar">
                    <div class="cookie-content">
                        ...
                        <div class="cookie-buttons">
                            ...
                            <a href="./mad-car-arena-cookies.html" class="btn-secondary">Learn More</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="header-content">
                            ...
                            <nav class="nav">
                                <ul class="nav-list">
                                    ...
                                    <li class="nav-item"><a href="./mad-car-arena-news.html" class="nav-link" id="nav-news">News</a></li>
                                    <li class="nav-item"><a href="./mad-car-arena-contact.html" class="nav-link" id="nav-contact">Contact</a></li>
                                </ul>
                            </nav>
...
async function loadFooter() {
  try {
    const response = await fetch("./mad-car-arena-partials/footer.html");
    if (!response.ok) {
      throw new Error(`HTTP error! status: ${response.status}`);
    }
                        ...
                        <div class="footer-content">
                            ...
                            <div class="footer-section">
                                ...
                                <ul class="footer-links">
                                    <li><a href="./mad-car-arena-cookies.html" class="footer-link">Cookie Policy</a></li>
                                    <li><a href="./mad-car-arena-privacy.html" class="footer-link">Privacy Policy</a></li>
                                    <li><a href="./mad-car-arena-disclaimer.html" class="footer-link">Disclaimer</a></li>
                                </ul>
                            </div>
                        </div>
...
function getCurrentPage() {
  ...
  if (path.includes("mad-car-arena-news.html")) return "news";
  if (path.includes("mad-car-arena-contact.html")) return "contact";
  return "home";
}
